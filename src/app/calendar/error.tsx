    ...
    <div className="min-h-screen bg-farm-cream flex items-center justify-center px-6">
      <div className="text-center space-y-5 max-w-sm">
        <div className="relative mx-auto w-32 h-32">
          <img
            src="/assets/pressfarm/flowers/anise-hyssop.png"
            alt=""
            aria-hidden="true"
        ...
        <h2 className="font-display text-2xl text-farm-dark">Couldn&apos;t load the harvest calendar</h2>
        <p className="text-sm text-farm-muted leading-relaxed">
          {error.message || "We couldn't load the calendar. Please try again."}
        </p>
