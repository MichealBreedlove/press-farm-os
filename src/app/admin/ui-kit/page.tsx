...
const ASSET_PATHS = [
  ...
  { label: "Circular seal (light)", path: "/assets/pressfarm/logo/png/pressfarm-circular-seal-light.png" },
  { label: "Circular seal (dark)", path: "/assets/pressfarm/logo/png/pressfarm-circular-seal-dark.png" },
  { label: "Horizontal logo", path: "/assets/pressfarm/logo/png/pressfarm-horizontal-logo.png" },
  { label: "Stacked logo", path: "/assets/pressfarm/logo/png/pressfarm-stacked-logo.png" },
  { label: "Wordmark only", path: "/assets/pressfarm/logo/png/pressfarm-wordmark-only.png" },
