...
const config: Config = {
  content: [
    ...
    // src/lib holds shared class maps (e.g. lanes.ts) — scan it too so
    // classes that live ONLY here (like the Under-Study arbitrary green)
    // are generated instead of purged.
